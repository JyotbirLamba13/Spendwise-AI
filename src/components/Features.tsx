...
const features = [
  ...
  },
  {
    ...
    details: "By analyzing your historical run-rate, ClearSpend detects subtle percentage increases in usage-based pricing models (like AWS or Stripe) and alerts you before they become massive budget overruns."
  },
  {
    icon: Repeat,
  ...
  },
  {
    ...
    details: "ClearSpend doesn't just show you data; it provides actionable steps. Like recommending a switch to Annual billing for a 20% discount on a vendor you've used consistently for 8 months."
  }
];
